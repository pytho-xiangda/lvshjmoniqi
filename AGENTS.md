...
- 当前日常房间已接入 Godot：主场景 `scenes/daily_room_demo.tscn`；背景 `assets/art/daily/daily_room_side_v04.png`；人物比例、轻松步态与环境动态规范 `docs/design/art/daily_room_side_v07.md`；Godot 实录 `assets/videos/daily_room_godot_demo_v07.mp4`。v01–v06 为历史草案。
