...
- 当前日常房间为固定正侧视横版场景：`assets/art/daily/daily_room_side_v04.png`；人物比例、八阶段自然行走与接入规范：`docs/design/art/daily_room_side_v06.md`；可交互预览：`docs/design/art/daily_room_side_preview.html`；24 fps 场景动画：`assets/videos/daily_room_side_walk_v06.mp4`。v01–v04 为历史草案。
